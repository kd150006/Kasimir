...
namespace Kasimir.Web.Admin.Controllers
{
    public class ProductTypeController : Controller
    {
        ...
        {
            var productTypeOverview = _uow.ProductTypeRepository.GetAll().ToArray();            
        ...
        public IActionResult Create([Bind("Status,Number,Name,GrossPrice,NetPrice,Barcode,IsActive,Id,RowVersion")] ProductType productType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult Edit(int id, [Bind("Status,Number,Name,GrossPrice,NetPrice,Barcode,IsActive,Id,RowVersion")] ProductType productType)
        {
